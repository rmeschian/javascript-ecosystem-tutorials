  ...
  function tokenBase(stream, state) {
    ...
    if (ch == "@") {stream.eatWhile(/[\w\-]/); return ret("meta", stream.current());}
      ...
      if(stream.eat("/")){
        ...
        if( /\/|\)|#/.test(stream.peek() || (stream.eatSpace() && stream.peek() == ")"))  || stream.eol() )return ret("string", "string"); // let url(/img/logo.png) without quotes return as string
      }
    }
    else if (ch == "!") {
      stream.match(/^\s*\w*/);
      ...
      if(type == "string"){
        ...
        return ret("string", "string"); // let url(/img/logo.png) without quotes return as string
